public class TaiKhoan {
    ...
    public TaiKhoan(String soTaiKhoan, String tenChuTaiKhoan,
        ...
        if (Double.isNaN(soDu) || Double.isInfinite(soDu) || soDu < 0) {
    ...
    public boolean napTien(double soTien) {
        if (Double.isNaN(soTien) || Double.isInfinite(soTien) || soTien <= 0) {
        ...
        System.out.printf("Số dư hiện tại: %,.0f đồng.%n", soDu);
        return true;
    }
